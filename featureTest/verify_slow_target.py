...
用法：
    python featureTest/verify_slow_target.py                # 关键 6 条（默认，约 1~2 分钟）
    python featureTest/verify_slow_target.py --full         # 全部用例（慢，约 5 分钟）
    SLOW_MS=800 python featureTest/verify_slow_target.py    # 加大延迟（更接近"拥挤机器"）
