  ...
  <table class="tbl">
    ...
    <tr>
      ...
      <td><span class="code-inline">scenarios/&lt;模块&gt;/&lt;场景id&gt;.yml</span><br>
          自然语言动作流（人话）</td>
      <td><span class="code-inline">cases/&lt;用例id&gt;.json</span><br>
          结构化步骤 + 断言（机器话）</td>
    </tr>
    <tr>
      <td><b>入口命令</b></td>
    ...
    <tr>
      <td><b>产出</b></td>
      <td><span class="code-inline">cases/ai_&lt;场景id&gt;_&lt;HHMMSS&gt;.json</span>（AI 写的用例）</td>
      <td>直接进 <span class="code-inline">scripts/test_cases.py</span>（无中间产物）</td>
    </tr>
    <tr>
      <td><b>花不花 token</b></td>
...
# ② 抄一个最像的现成用例改（手搓样例：cases/hand_enter_search.json）
cp cases/hand_enter_search.json cases/&lt;你的用例id&gt;.json
...
# ④ 只跑你这一条（按 case_id 过滤）
python -m pytest scripts/test_cases.py -q -k &lt;你的用例id&gt;
...
ls log/&lt;run_id&gt;/          # 用例日志 / report.html / trace
  ...
  <table class="tbl">
    ...
    <tr>
      <td><b>① 只改源头，不改产物</b></td>
      <td><span class="code-inline">scripts/test_cases.py</span>、<span class="code-inline">scripts/conftest.py</span>、
  ...
  <table class="tbl">
    ...
    <tr><td>只跑我刚写的那条</td><td>—</td><td><span class="code-inline">pytest scripts/test_cases.py -q -k &lt;case_id&gt;</span></td></tr>
