...
sys.path.insert(0, str(Path(__file__).resolve().parent))       # 同目录辅助模块（frameworkTest/）
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "featureTest"))   # 二类 runner 住 featureTest/
