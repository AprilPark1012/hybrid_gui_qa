...
跑法：
    cd ~/hybrid_gui_qa && .venv/bin/python -m pytest tests/frameworkTest/test_import_targets.py -v
"""
...
# tests/frameworkTest/ tests/featureTest/ scripts/ build_tools/ 都不是包（无 __init__.py），故不列入 —— 避免误报）
