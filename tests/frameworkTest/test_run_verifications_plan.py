...
sys.path.insert(0, str(Path(__file__).resolve().parent))       # 同目录辅助模块（tests/frameworkTest/）
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "tests" / "featureTest"))   # 二类 runner 住 tests/featureTest/
